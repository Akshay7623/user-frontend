...
const Bank = () => {
  ...
  useEffect(()=>{
   AuthUser().then((data)=>{
     ...
     fetch('http://localhost:5000/api/getbankcard',{
     method:'get',
     headers:{
...
const AddBank = ()=>{
  ...
  const hanldeSubmit = ()=>{
    ...
    fetch('http://localhost:5000/api/addbank',{
      method:'post',
...
const AddUpi = ()=>{
    ...
    const hanldeSubmit = ()=>{
      ...
      fetch('http://localhost:5000/api/addupi',{
      method:'post',
...
const EditBank = ()=>{
      ...
      const hanldeChange = (e)=>{
       ...
       const hanldeSubmit = ()=>{
        ...
        fetch('http://localhost:5000/api/updatebank',{
          method:'post',
          body:JSON.stringify(bankData),
          headers:{
            'Content-Type':'application/json',
  ...
  useEffect(()=>{
   ...
   fetch('http://localhost:5000/api/getbank',{
    method:'post',
...
const EditUpi = ()=>{
    ...
    const hanldeSubmit = ()=>{
        ...
        fetch('http://localhost:5000/api/updateupi',{
          method:'post',
          body:JSON.stringify(upiData),
          headers:{
            'Content-Type':'application/json',
